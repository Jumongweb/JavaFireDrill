...
public class EstoreTest {
    ...
    @Test
    public void testThatIHaveAnE_StoreWithNoAdmin_AddAdmin(){
        assertEquals(0, estore.getNumberOfAdmin());
        estore.createAdmin(
    ...
    @Test
    public void testThatE_storeNumberOfSellerIsZeroByDefault(){
        assertEquals(0, estore.getNumberOfSeller());
    }

    @Test
    public void testThatE_StoreCanAddSeller(){
    ...
    public void testThatMyE_StoreAndCanAddMoreThanOneSeller(){
        ...
        estore.add(seller2);
        estore.add(seller3);
        assertEquals(3, estore.getNumberOfSeller());
    }

    @Test
    public void testthatE_StoreCanAddBuyersAndSellers(){
        assertEquals(0, estore.getNumberOfSeller());
        assertEquals(0, estore.getNumberOfCustomer());
        Seller seller1 = new Seller(20, "jumong@semicolon.com",
                "No 6, Paradise street, Sans Fransico, America","Jumong",
                "password","08193849844");
        estore.add(seller1);

        Customer customer1 = new Customer(24, "lawal@semicolon.com",
                "No 6, Genius street, Toronto, Canada","Jumong",
                "password","08193849844");
        estore.add(customer1);
        assertEquals(1, estore.getNumberOfSeller());
        assertEquals(1, estore.getNumberOfCustomer());
    }
